...
int main(int argc, char *argv[])
{
    ...
    if(listen(serv_sock, 20) == -1) error_handling((char*)"listen() error");
...
char *content_type(char *file)
{
    ...
    if(!strcmp(extension, "html") || !strcmp(extension, "htm")) return (char*)"text/html";
...
void send_error(FILE *fp)
{
    ...
    char content[] = "<html> <h1>hahahaha, we only accept GET because the maker is too low!</h1>\r\n";
